...
public class LoginPage {
    ...
    @FindBy (xpath = "//p/span[text()='Email is not valid!']")
    public WebElement invalidEmailErrorMessage;

    public String expectedErrorMessageInvalidEmailFormat ="Email is not valid!";

    public String invalidFormatEmail = "admin.com";
